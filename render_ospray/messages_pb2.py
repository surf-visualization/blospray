...
_CLIENTMESSAGE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REQUEST_RENDER_OUTPUT', index=17, number=49,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_SERVER_STATE', index=18, number=50,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUERY_BOUND', index=19, number=51,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='QUIT', index=20, number=99,
      serialized_options=None,
      type=None),
  ],
...
_MATERIALUPDATE_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='THIN_GLASS', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
